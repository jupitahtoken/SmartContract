...
contract JUPITAH is Context, IBEP20, Ownable, ReentrancyGuard {
	using SafeMath for uint256;
	using Address for address;

	address payable public charityAddress = 0x621F4cB56f3D1B6A1AB6786bF852e4A3AAB94Df3;
	...
	string private _name = "JUPITAH TOKEN";
	string private _symbol = "JUPITAH";
    ...
    // Innovation for protocol by JUPITAH Team
	uint256 public rewardCycleBlock = 3 days;
	uint256 public easyRewardCycleBlock = 3 days;
    ...
    function calculateBNBReward(address ofAddress) public view returns (uint256) {
    	uint256 totalSupplyReward = uint256(_tTotal)
    ...
    function claimBNBReward() isHuman nonReentrant public {
    	...
    	require(balanceOf(msg.sender) >= 0, 'Error: must own JUPITAH to claim reward');
